...
public struct AlchemyTokenHoldingsProvider: TokenHoldingsProviding, TokenBalancesProviding {
    ...
    public func tokenBalances(for request: TokenBalancesRequest) async throws -> TokenBalancesPage {
...
public extension AlchemyTokenHoldingsProvider {
