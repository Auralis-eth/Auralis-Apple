...
public enum DecimalQuantityFormatter {
    public static let hiddenAmountDisplay = "Amount hidden"

    public struct TokenAmountPresentation: Equatable {
        public let displayText: String
        public let isHidden: Bool

        public init(displayText: String, isHidden: Bool) {
            self.displayText = displayText
            self.isHidden = isHidden
        }
    }

    public static func tokenAmountPresentation(
        ...
        guard let decimals else {
            return TokenAmountPresentation(
                displayText: hiddenAmountDisplay,
                isHidden: true
            )
        }
