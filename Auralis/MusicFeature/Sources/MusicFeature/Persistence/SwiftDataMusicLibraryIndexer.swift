...
@MainActor
public final class SwiftDataMusicLibraryIndexer: MusicLibraryIndexing {
    ...
    public func itemCount(accountAddress: String?, chain: Chain) throws -> Int {
    ...
    public func needsRebuild(accountAddress: String?, chain: Chain) async throws -> Bool {
    ...
    func makeDescriptor(from nft: NFT) -> MusicLibraryItemDescriptor {
        ...
        let artworkURLString = artworkCandidates
            .compactMap { rawValue -> String? in
                ...
                return sanitizedRemoteMediaURL(from: rawValue)?.absoluteString
            }
            .first
