...
struct AuraColorTests {
    ...
    func parsesShorthandHex() throws {
        let components = try #require(Color.rgbaComponents(from: "#0F8"))
    ...
    func parsesAlphaHex() throws {
        let components = try #require(Color.rgbaComponents(from: "7751A980"))
