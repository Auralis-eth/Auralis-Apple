...
extension CodeScannerView {
    ...
    public final class ScannerViewController: UIViewController, UINavigationControllerDelegate {
        ...
        override public func loadView() {
            ...
            let simulatedCodeButton = UIButton(type: .system)
            simulatedCodeButton.translatesAutoresizingMaskIntoConstraints = false
            simulatedCodeButton.setTitle("Use simulated code", for: .normal)
            simulatedCodeButton.addTarget(self, action: #selector(useSimulatedCodeFromButton), for: .touchUpInside)
            simulatedCodeButton.accessibilityHint = "Sends the configured simulated scan result"
            simulatedCodeButton.accessibilityTraits.insert(.button)
            ...
            button.accessibilityLabel = "Select image from photo library"
            button.accessibilityHint = "Opens your photo library to choose a QR code image"
            ...
            stackView.addArrangedSubview(simulatedCodeButton)
            stackView.addArrangedSubview(button)

            view.addSubview(stackView)

            NSLayoutConstraint.activate([
                simulatedCodeButton.heightAnchor.constraint(greaterThanOrEqualToConstant: 50),
        ...
        private func sendSimulatedCode() {
            found(ScanResult(
