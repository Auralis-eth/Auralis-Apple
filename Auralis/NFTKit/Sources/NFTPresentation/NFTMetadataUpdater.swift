...
public enum NFTMetadataUpdater {
    public struct ParsedAttribute: Sendable {
        let value: String
        let traitType: String?
    }

    public enum MetadataUpdate<Value: Sendable>: Sendable {
        case unchanged
        case set(Value)
    }

    public struct MetadataPatch: Sendable {
    ...
    public static func updateNFTFromMetadata(nft: NFT, metadata: [String: JSONValue]?) {
        applyMetadataPatch(metadataPatch(from: metadata), to: nft)
    }

    public static func metadataPatch(from metadata: [String: JSONValue]?) -> MetadataPatch {
    ...
    public static func applyMetadataPatch(_ patch: MetadataPatch, to nft: NFT) {
